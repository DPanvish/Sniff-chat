...
import assets, { messagesDummyData } from '../lib/assets'
  ...
  return selectedUser ?(
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      ...
      <div className="flex items-center gap-3 py-3 mx-4 border-b border-stone-500">
        <img src={selectedUser.profilePicture || assets.avatar_icon} alt="Profile Pic" className="w-8 rounded-full" />
        ...
        {messages.map((msg, index) => (
          ...
          >
            ...
            <div className="text-center text-xs">
              <img 
                src={msg.senderId !== authUser._id ? selectedUser?.profilePicture || assets.avatar_icon : authUser?.profilePicture || assets.avatar_icon} 
                alt="Avatar Icon" 
    ...
    <div className="flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden">
      <img src={assets.logo_icon} className="max-w-16" alt="Sniff Chat Logo" />
